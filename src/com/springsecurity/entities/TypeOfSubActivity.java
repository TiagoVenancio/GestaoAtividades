...
@Entity
@Table(name = "sg_act_type_sub_activity", schema = "gestao_atividades")
public class TypeOfSubActivity implements Serializable {
	private static final long serialVersionUID = -7590317347612436291L;

	@Id
	@GeneratedValue
	@Column(name = "TYPE_SUB_ACTIVITY_ID", length = 20)
	private Long id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TypeOfSubActivity other = (TypeOfSubActivity) obj;
		if (createDate == null) {
	...
	public String toString() {
		return "TypeOfSubActivity [id=" + id + ", createDate=" + createDate
